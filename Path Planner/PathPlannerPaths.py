        ...
        waypoints = [
            {
                ...
                "prevControl": None,
                "nextControl": {"x": parsed_data[end][0], "y": parsed_data[end][1]},
                "isLocked": False,
                "linkedName": start
            },
            {
                "anchor": {"x": parsed_data[end][0], "y": parsed_data[end][1]},
                "prevControl": {"x": parsed_data[start][0], "y": parsed_data[start][1]},
                "nextControl": None,
                "isLocked": False,
                "linkedName": end
            }
...
# Example usage
data = (
    "S1:X:8.103688524590162,Y:7.111834016393442; "
    "S2:X:8.103688524590162,Y:6.0; "
    "S3:X:8.103688524590162,Y:5.025973360655737; "
